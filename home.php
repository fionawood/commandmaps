...
<ul>Then click the <button>Next</button> button for the next icon, your new target.</ul>
</div>

<h3>We have 2 interfaces for you to test out. First, some practice. Click the next button below to begin.</h3>
